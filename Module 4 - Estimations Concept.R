...
MAX = 1 # This can be change to reduce to save time. The runs used in the Paper considers 20 iterations in this section
...
# Iterations
MAX = 10 # The Paper uses 100 iterations. We changed it here to reduce the running times

# NAs targets
targets <- c(2) # The Paper uses c(10,5,3,4,2,1). We only use one value to reduce running times
